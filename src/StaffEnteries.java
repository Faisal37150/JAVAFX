...
public class StaffEnteries  {
	
	Stage window;
	 
	static Scene scene;
	
	StaffEnteries(String title,int width,int height){
		window = new Stage();
	...
	int totalLines(){
		try {
			...
			FileReader fr = new FileReader("file://../data/Staff Enteries.txt");
	...
	String[][] Reader() {
	 ...
	 public static void Writer(String data, boolean append) {
		 ...
		 try {
			 FileWriter fw = new FileWriter("file://../data/Staff Enteries.txt", append);
			 fw.write(data);
			 fw.close();
